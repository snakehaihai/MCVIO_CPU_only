...
The key purpose of this repo is to run the MCVIO without VPI and without changing system eigen, opencv and ceres. Also deleted the internal eigen in thirdparty directory since the author didn`t even bother to include it in cmakelist.
